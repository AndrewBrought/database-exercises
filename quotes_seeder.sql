...
-- Truncate means we are going to wipe the quotes table clean / similar to dropping a table in a migration file
TRUNCATE quotes;
...
INSERT INTO quotes (author_last_name, quote)
VALUES ('Thompson', 'Too weird to live...too rare to die.');